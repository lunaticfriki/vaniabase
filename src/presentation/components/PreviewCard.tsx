...
export function PreviewCard({ item }: PreviewCardProps) {
  return (
    <a
      ...
      class="block group relative bg-zinc-900 border border-brand-violet rounded-sm overflow-hidden hover:border-brand-magenta/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,0,255,0.15)] hover:-translate-y-1"
    >
