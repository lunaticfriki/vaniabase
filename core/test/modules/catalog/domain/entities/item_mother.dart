...
class ItemMother {
  ...
  static Item book() => Item.create(
        ...
        format: ItemFormats.create([Format.paperback]),
        tags:
            ItemTags.create([Tag.create('programming'), Tag.create('classic')]),
        ...
        language: Languages.create([Language.create('en')]),
  ...
  static Item movie() => Item.create(
        ...
        format: ItemFormats.create([Format.bluRay]),
  ...
  static Item videogame() => Item.create(
        ...
        format: ItemFormats.create([Format.cartridge]),
