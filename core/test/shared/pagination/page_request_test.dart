...
void main() {
  group('PageRequest', () {
    ...
    test('first returns page 1 with the given pageSize', () {
      expect(PageRequest.first(pageSize: 20),
          PageRequest.create(page: 1, pageSize: 20));
    });

    test('equality is structural', () {
      expect(PageRequest.create(page: 2, pageSize: 10),
          PageRequest.create(page: 2, pageSize: 10));
    });
  });
}
